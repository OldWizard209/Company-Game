...
def company():
    ...
    def product_sales():
        def tech():
            ...
            if specialization == 'Technology':
                product_make = input(f"\n\n{green}Revenue(Money): {revenue}\n\nWhat product would you like to design in technology:\n\n         [1] Phone\n         [2] Laptops\n         [3] Watches\n         [4] Or go back.\n ---> ")
                ...
                while True:
                    ...
                    if product_make == '1':
                        ...
                        if max_products != products: 
                            ...
                            shares_num += 50
                            products += 1
                            print(f"You have {phone_products} phone product(s).") 
                            break
                    ...
                    if product_make == '2':
                        ...
                        if max_products != products: 
                            ...
                            shares_num += 50
                            products += 1
                            print(f"You have {laptop_products} laptop product(s).")    
                            break
                    ...
                    if product_make == '3':
                        ...
                        if max_products != products:  
                            ...
                            shares_num += 50
                            products += 1
                            print(f"You have {watch_products} watch product(s).")                          
                            break
        ...
        def clothing():
            ...
            if specialization == 'Clothing':
                product_make = input(f"\n\n\n\n{green}Revenue(Money): {revenue}\n\nWhat product would you like to design in clothing:\n\n         [1]  Casual Clothes\n         [2] Suits\n         [3] Fshion Accesory\n         [4] Or go back.\n ---> ")
                ...
                while True:
                    ...
                    if product_make == '1':
                        ...
                        if max_products != products:
                            ...
                            products += 1
                            print(f"You have {casual_clothing_products} products")
                            break
                    ...
                    if product_make == '3':
                        ...
                        while max_products != products:
                            ...
                            fashion_accessory_products += 1
                            products += 1 
                            print(f"You have {fashion_accessory_products} Fashion Accesory Products")                          
    ...
    def sell_products():
        ...
        global laptop_products, watch_products, products, fashion_accessory_products
        global suits_product, casual_clothing_products
        if products == 0:
        ...
        if specialization == 'Technology':
            ...
            while sell in nums_3:
                    ...
                    if phone_products > 0:
                        ...
                        while True:                           
                            try:  
                                ...
                                how_many = int(input("How many products do you want to sell: "))
                                if phone_selling_price > 500 and phone_selling_price < 7000:
                                    revenue += phone_selling_price*how_many
                        ...
                        break 
                if sell == '2':
                    if laptop_products == 0:
                        print("You don't have any laptop product")
                        break
                    if laptop_products > 0:
                        laptop_products -= 1
                        products -= 1
                        while True:
                            try:  
                                ...
                                if laptop_selling_price > 1000 and laptop_selling_price < 10000:
                                    revenue += laptop_selling_price*how_many
                                    revenue -= 800*how_many
                                    break
                                break
                            except : 
                                # let the loop go again  
                ...
                if sell == '3':
                    if watch_products == 0:
                        print("You don't have any watch product")
                        break
                    if watch_products > 0:
                        watch_products -= 1
                        products -= 1
                        while True:
                            try:  
                                ...
                                if watch_selling_price > 100 and watch_selling_price < 2000:
                                    revenue += watch_selling_price*how_many
                                    revenue -= 300*how_many
                                    break
                                break
                            except ValueError: 
                                # let the loop go again  
        ...
        if specialization == 'Clothing':
            print(green + f"\nYou have:\n{casual_clothing_products} Casual Clothes Products\n{suits_products} Suit Products\n{fashion_accessory_products} Fashion Accesory Products.\n")
            sell = input("\nWhat product do you want to sell:\n         [1] Casual clothes\n         [2] Suits\n         [3] Fasion Accesories.\n--->")

            while sell in nums_3:
                if sell == '1':
                    if casual_clothing_products == 0:
                        print("You don't have any Casual Clothes Products")
                        break
                    if casual_clothing_products > 0:
                        casual_clothing_products -= 1
                        products -= 1
                        while True:
                            try:  
                                print('\nCausal Clothes prices must be $50 to $100 dollars.') 
                                ...
                                if casual_selling_price > 50 and casual_selling_price < 100:
                                    revenue += casual_selling_price*how_many
                                    revenue -= 50*how_many                                                            
                                    break
                                break
                            except ValueError: 
                ...
                if sell == '2':
                    if suits_products == 0:
                        print("You don't have any suit products.")
                        break
                    if suits_products > 0:
                        products -= 1
                        suits_product -= 1
                        while True:
                            try:  
                                ...
                                if suit_selling_price > 70 and suit_selling_price < 120:
                                    revenue += suit_selling_price*how_many
                                    revenue -= 75*how_many
                                    break
                            except ValueError: 
                                # let the loop go again  
                ...
                if sell == '3':
                    if fashion_accessory_products == 0:
                        print("You don't have any Fashion Accesory Products.")
                        break
                    if fashion_accessory_products > 0:
                        products -= 1
                        fashion_accessory_products -= 1
                        while True:
                            try:  
                                ...
                                if fashion_selling_price > 30 and fashion_selling_price < 60:
                                    revenue += fashion_selling_price*how_many
                                    revenue -= 25*how_many
                                    break
                                break
                            except ValueError: 
    ...
    while True:
        ...
        while first_choice in nums_3:
            ...
            if first_choice == '2':
                company_work = input(wheat_4 + f"\n\n{green}Company Name: {company_name.title()}.INC\nSpecialization: {specialization}\nRevenue: {revenue}\nEmployees: {employee_num}\nProducts Made: {products}\nShares: {shares_num}\nShares Sold: {shares_sold}\n\nHere is what you can do with your company:\n\n         [1] Hire new employees\n         [2] Build a product.\n         [3] Sell shares\n         [4] Sell your products\n         [5] Or go back.\n---> ")
